import { d as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, e as clsx, R as React, i as invariant, j as jsxRuntimeExports, L as Link } from "./index-DYWh7W97.js";
import { A as ALL_CATEGORIES, E as EXAM_CONFIGS } from "./examData-BshUSf5y.js";
import { c as createLucideIcon, a as getAllAttempts, g as getSettings, L as Layout, C as Card, S as Shield, B as Button, h as ChevronRight, b as getBadge, f as formatTime, p as CardHeader, q as CardTitle, r as CardContent, e as Separator, s as saveSettings, t as deleteAllAttempts } from "./examUtils-B-u_nfMy.js";
import { A as AlertDialog, h as AlertDialogTrigger, a as AlertDialogContent, b as AlertDialogHeader, c as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, f as AlertDialogCancel, g as AlertDialogAction } from "./alert-dialog-B4Gfpwdk.js";
import { B as Badge, R as RefreshCw } from "./badge-DnH4m7rw.js";
import { P as Progress, C as Clock } from "./progress-ygDwT6nd.js";
import { C as ChartColumn, S as Star, a as Switch } from "./switch-GWhS9JBp.js";
...
function barColor(pct) {
  if (pct >= 80) return "oklch(0.40 0.20 250)";
  if (pct >= 65) return "oklch(0.60 0.08 230)";
  return "oklch(0.65 0.19 22)";
}
function CustomTooltip({ active, payload }) {
  if (!active || !(payload == null ? void 0 : payload.length)) return null;
  const d2 = payload[0];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg px-3 py-2 text-xs shadow-lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold mb-1", children: d2.payload.category }),
...
function CategoryChart({ categoryScores }) {
  const data = ALL_CATEGORIES.filter(
    (cat) => {
      var _a;
      return ((_a = categoryScores[cat]) == null ? void 0 : _a.total) > 0;
    }
  ).map((cat) => ({
    category: cat,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: "100%", overflowX: "auto" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { minWidth: 520 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    BarChart,
    {
      data,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "pct", radius: [4, 4, 0, 0], maxBarSize: 32, children: data.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: barColor(entry.pct) }, entry.category)) })
      ]
    }
  ) }) }) });
}
...
function examTrend(examAttempts) {
  if (examAttempts.length < 2) return "flat";
  const last3 = [...examAttempts].sort(
    (a2, b2) => new Date(b2.completedAt).getTime() - new Date(a2.completedAt).getTime()
  ).slice(0, 3);
...
function motivationMsg(avg, total) {
...
function DashboardPage() {
  ...
  const avgScore = totalAttempts > 0 ? Math.round(
    attempts.reduce((s2, a2) => s2 + a2.percentage, 0) / totalAttempts
  ) : 0;
  const bestScore = totalAttempts > 0 ? Math.max(...attempts.map((a2) => a2.percentage)) : 0;
  const bestBadge = totalAttempts > 0 ? Object.entries(BADGE_RANK).reduce(
    (best, [b2, rank]) => attempts.some((a2) => a2.badge === b2) && rank > (BADGE_RANK[best] ?? 0) ? b2 : best,
    "Rookie"
  ) : null;
  const totalQuestionsAnswered = attempts.reduce(
    (s2, a2) => s2 + a2.totalQuestions,
    0
  );
  ...
  const sortedWeakFirst = ALL_CATEGORIES.filter(
    (c2) => {
      var _a;
      return ((_a = categoryScores[c2]) == null ? void 0 : _a.total) > 0;
    }
  ).sort((a2, b2) => categoryScores[a2].percentage - categoryScores[b2].percentage);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-bold text-2xl flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { className: "w-6 h-6 text-primary" }),
          "Performance Dashboard"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: totalAttempts > 0 ? `${totalAttempts} attempt${totalAttempts !== 1 ? "s" : ""} — ${totalQuestionsAnswered} questions answered` : "Track your progress across all 4 exams" })
      ] }),
      totalAttempts > 0 && bestBadge && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden sm:block", children: badgePill(bestBadge) })
    ] }),
    totalAttempts === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "w-14 h-14 text-muted-foreground mx-auto mb-4 opacity-30" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-lg mb-2", children: "No Exams Attempted Yet" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-6 max-w-sm mx-auto", children: "Complete your first exam to unlock performance analytics, category breakdowns, and badge progress." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "gap-1", "data-ocid": "start-first-exam-btn", children: [
            "Start with Exam 1 ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: statCards.map((s2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Card,
            {
              className: "p-4 text-center border border-border",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-1.5 text-muted-foreground mb-1 text-xs", children: [
                  s2.icon,
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: s2.label })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-2xl", children: s2.value })
              ]
            },
            s2.label
          ))
      ...
      bestBadge && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-1", children: "Best Badge Earned" }),
              badgePill(bestBadge)
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right flex-1 max-w-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-1", children: "Average Score" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Progress, { value: avgScore, className: "h-2 mb-1 progress-gold" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-semibold text-base mb-3 flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: EXAM_CONFIGS.map((config2) => {
            const examAttempts = attempts.filter(
              (a2) => a2.examId === config2.id
            );
            const sorted = [...examAttempts].sort(
              (a2, b2) => new Date(b2.completedAt).getTime() - new Date(a2.completedAt).getTime()
            );
            const best = examAttempts.length > 0 ? examAttempts.reduce(
              (b2, a2) => a2.percentage > b2.percentage ? a2 : b2,
              examAttempts[0]
            ) : null;
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Card,
              {
                ...
                "data-ocid": `exam-card-${config2.id}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2 mb-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm", children: config2.title }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                        examAttempts.length,
                        " attempt",
                        examAttempts.length !== 1 ? "s" : "",
                        lastAttempt ? ` — Last: ${new Date(lastAttempt.completedAt).toLocaleDateString()}` : ""
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                      trend === "up" && /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-3.5 h-3.5 text-green-500" }),
                      trend === "down" && /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "w-3.5 h-3.5 text-destructive" }),
                      trend === "flat" && examAttempts.length >= 2 && /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "w-3.5 h-3.5 text-muted-foreground" }),
                      best && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Badge,
                        {
                          className: `text-xs ${BADGE_COLORS[getBadge(best.percentage)]}`,
                          children: getBadge(best.percentage)
                        }
                      )
                    ] })
                  ] }),
                  best ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs text-muted-foreground mb-1", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                        "Time: ",
                        formatTime(best.timeSpentSeconds)
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Progress,
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        ...
                        {
                          to: "/history/$examId",
                          params: { examId: String(config2.id) },
                          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            Button,
                            {
                              ...
                              "data-ocid": `history-btn-${config2.id}`,
                              children: [
                                "View History ",
                        ...
                        Link,
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            Button,
                            {
                              ...
                              size: "sm",
                              className: "text-xs gap-1",
                              "data-ocid": `retake-btn-${config2.id}`,
                              children: [
                    ...
                    Link,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Button,
                        {
                          ...
                          "data-ocid": `start-btn-${config2.id}`,
                          children: "Start Exam"
                        }
                      )
                    }
        ...
        Card,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-2 pt-4 px-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "font-display text-sm font-semibold flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { className: "w-4 h-4 text-primary" }),
                "Average Score by Category (All Exams)"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Red dashed line = 80% pass threshold" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "px-3 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryChart, { categoryScores }) })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border border-border mb-6", "data-ocid": "category-list", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 pt-4 px-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-sm font-semibold", children: "Category Breakdown (Weakest First)" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "px-5 pb-4 space-y-3", children: [
          sortedWeakFirst.map((cat) => {
            ...
            const colorClass = cs.percentage >= 80 ? "text-green-500" : cs.percentage >= 65 ? "text-primary" : "text-destructive";
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground truncate mr-2", children: cat }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
          ...
          sortedWeakFirst.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm text-center py-3", children: "No category data yet." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-semibold text-base mb-3 flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: recentAttempts.map((attempt, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3 px-4 py-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium truncate", children: attempt.examTitle }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
            ...
            idx < recentAttempts.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, {})
          ] }, attempt.id)) })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-semibold text-base mb-3 flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground italic", children: motivationMsg(avgScore, totalAttempts) }),
            strongest && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-green-500 mt-0.5 flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Strongest area:" }),
                " ",
                strongest,
                " (",
                categoryScores[strongest].percentage,
                "%) — Keep it sharp."
              ] })
            ] }),
            weakest && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { className: "w-4 h-4 text-destructive mt-0.5 flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Weakest area:" }),
                " ",
                weakest,
                " (",
                categoryScores[weakest].percentage,
                "%) — Prioritize more practice here."
              ] })
            ] }),
            sortedWeakFirst.length >= 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground mb-2 uppercase tracking-wide", children: "Top Focus Areas" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: sortedWeakFirst.slice(0, 3).map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Badge,
                {
                  variant: "outline",
        ...
        Card,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "Randomize Question Order" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Shuffle questions each time you start an exam" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Switch,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "Randomize Answer Order" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Shuffle A/B/C/D options for each question" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Switch,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-destructive", children: "Clear All History" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialog, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Clear All Attempts?" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", "data-ocid": "back-to-home-btn", children: "Back to Home" }) }) })
    ] })
  ] });
}
export {
